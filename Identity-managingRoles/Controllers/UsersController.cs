...
public class UsersController : ControllerBase
{
    ...
    {
        // Simulate a logged-in user with a role, in a real application, this would come from the authentication system
        var user = new ClaimsPrincipal(new ClaimsIdentity(new[] //claims identity is created with a list of claims, in this case, we are adding a name claim and a role claim to simulate an authenticated user with the Admin role
        {
